...
def ensure_external_disk_schema() -> None:
    ...
    column_statements = {
        ...
        "filesystem_total_gb": "ALTER TABLE external_disks ADD COLUMN filesystem_total_gb INTEGER",
        "filesystem_used_gb": "ALTER TABLE external_disks ADD COLUMN filesystem_used_gb INTEGER",
        "filesystem_free_gb": "ALTER TABLE external_disks ADD COLUMN filesystem_free_gb INTEGER",
