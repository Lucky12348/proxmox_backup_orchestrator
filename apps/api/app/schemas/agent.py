...
class AgentDiskReportItem(BaseModel):
    ...
    filesystem_total_gb: int | None = Field(default=None, ge=0)
    filesystem_used_gb: int | None = Field(default=None, ge=0)
    filesystem_free_gb: int | None = Field(default=None, ge=0)
